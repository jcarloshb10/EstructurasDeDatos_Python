...
class TestClubDeportivo(TestBuilder):
    ...
    def test_1_registrar_nuevo_socio(self):
        ...
        if self.dict_pruebas.get("registro"):
            ...
            sInfoCD = (
                "[Club Deportivo:Python Sports Club\n"
                "Teléfono:8-852670\n"
                "Total Socios:10\n"
            ...
            self.comprobarAserción2(
                False,
                self.club_depor.registrar_nuevo_socio,
                [SocioClub("456", "Carlos Hernández", "Clle 456", 1979)],
                Nt1_1,
                le,
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                True, self.club_depor.registrar_nuevo_socio, [sc_11], Nt1_1, le
            )
            ...
            self.comprobarAserción2(
                False,
                self.club_depor.registrar_nuevo_socio,
                [SocioClub("789", "Sandra Rojas", "Clle 789", 1968)],
                Nt1_1,
                le,
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                True, self.club_depor.registrar_nuevo_socio, [sc_12], Nt1_1, le
            )
            ...
            self.comprobarAserción2(
                False,
                self.club_depor.registrar_nuevo_socio,
                [SocioClub("110", "Zoila Vargas", "Clle 110", 2005)],
                Nt1_1,
                le,
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                False, self.club_depor.registrar_nuevo_socio, [scol], Nt1_1, le
            )
    ...
    def test_2_registrar_nuevo_socio_despues_de(self):
        ...
        if self.dict_pruebas.get("registro_despues"):
            ...
            self.comprobarAserción2(
                True,
                self.club_depor.registrar_nuevo_socio_despues_de,
                [sc_11, "234"],
                Nt2_1,
                le,
            )
        ...
        if self.dict_pruebas.get("antigüedad"):
            ...
            for datos_socio in lst_ra_5_OK:
                ...
                self.comprobarAserción(
                    True, unSocio in lst_ra_5, Nt4_3, le, cr_i
                )
                cr_i += 1
            ...
            for datos_socio in lst_ra_15_OK:
                ...
                le = (traceback.extract_stack()[-1])[1] + 1
                self.comprobarAserción(
                    True, unSocio in lst_ra_15, Nt4_3, le, cr_i
                )
                cr_i += 1
            ...
            for datos_socio in lst_ra_30_OK:
                ...
                le = (traceback.extract_stack()[-1])[1] + 1
                self.comprobarAserción(
                    True, unSocio in lst_ra_30, Nt4_3, le, cr_i
                )
                cr_i += 1
            ...
            for datos_socio in lst_ra_44_OK:
                ...
                le = (traceback.extract_stack()[-1])[1] + 1
                self.comprobarAserción(
                    True, unSocio in lst_ra_44, Nt4_3, le, cr_i
                )
                cr_i += 1
    ...
    def test_5_eliminar_socio(self):
        ...
        if self.dict_pruebas.get("eliminar"):
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                True, self.club_depor.eliminar_socio, ["345"], Nt5_1, le
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                False, self.club_depor.eliminar_socio, ["761"], Nt5_1, le
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                True, self.club_depor.eliminar_socio, ["110"], Nt5_1, le
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                True, self.club_depor.eliminar_socio, ["234"], Nt5_1, le
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                False, self.club_depor.eliminar_socio, ["345"], Nt5_1, le
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                True, self.club_depor.eliminar_socio, ["123"], Nt5_1, le
            )
    ...
    def test_6_todo(self):
        iTest = 6
        sTitle = (
            "Registrar, Modificar, Eliminar e Informes de Antigüedad "
            + "del Club Deportivo"
        )
        fMax_nota = 0.5
        ...
        if self.dict_pruebas.get("todo"):
            ...
            self.comprobarAserción2(
                False,
                self.club_depor.registrar_nuevo_socio,
                [SocioClub("456", "Martha Benavides", "Clle 456", 1968)],
                Nt6_4,
                le,
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                False, self.club_depor.registrar_nuevo_socio, [scol], Nt6_4, le
            )
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                True, self.club_depor.eliminar_socio, ["901"], Nt6_7, le
            )

            # Eliminación del socio con el número 123
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                True, self.club_depor.eliminar_socio, ["123"], Nt6_7, le
            )
            ...
            for datos_socio in lst_ra_7_OK:
                ...
                le = (traceback.extract_stack()[-1])[1] + 1
                self.comprobarAserción(
                    True, unSocio in lst_ra_7, Nt6_8, le, cr_i
                )
                cr_i += 1
            ...
            le = (traceback.extract_stack()[-1])[1] + 1
            self.comprobarAserción2(
                False, self.club_depor.eliminar_socio, ["111"], Nt6_7, le
            )
